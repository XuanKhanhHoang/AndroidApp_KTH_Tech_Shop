...
import com.ktm.kthtechshop.adapters.Adapter_CartRclView;
...
public class CartActivity extends NeededCallApiActivity implements Cart_CartItem_Checked_Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentBtn = findViewById(R.id.Cart_Payment_Btn);
        ...
        paymentBtn.setOnClickListener(v -> {
            if (checkingCartItems.isEmpty()) {
                Toast.makeText(this, "Vui lòng chọn sản phẩm cần thanh toán", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            for (CartItemSaved item : checkingCartItems
            ) {
                products.add(new CreateOrderIntentModel(item));
            }
